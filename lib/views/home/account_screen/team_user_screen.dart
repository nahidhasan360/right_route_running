...
// MAIN SCREEN
// -----------------------------------------------------------------------------
class TeamUserScreen extends StatelessWidget {
  TeamUserScreen({super.key});

  final c = Get.put(TeamUserManageAccountController());
  ...
  // Note: TeamUser screen does NOT have Current Plan or Manage Team sections
  // ─────────────────────────────────────────────────────────────
